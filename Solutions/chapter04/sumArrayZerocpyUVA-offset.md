...
__global__ void sumArraysZeroCopyWithUVAOffset(float *A, float *B, float *C,
...
int main(int argc, char **argv)
{
    ...
    start = seconds();
    sumArraysZeroCopyWithUVAOffset<<<grid, block>>>(h_A, h_B, d_C, nElem, offset);
    CHECK(cudaDeviceSynchronize());
    elapsed = seconds() - start;
    printf("sumArraysZeroCopyOffset w/ UVA, elapsed = %f s\n", elapsed);
